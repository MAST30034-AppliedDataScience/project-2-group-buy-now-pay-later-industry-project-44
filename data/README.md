...
- This is partitioned by the `order_datetime` field. For example, read the snapshot directories such as `transactions_20210228_20210827_snapshot/`, `transactions_20210828_20220227_snapshot/`, and `transactions_20220228_20220828_snapshot/`. Spark will treat the nested `order_datetime` directories as partition columns.
